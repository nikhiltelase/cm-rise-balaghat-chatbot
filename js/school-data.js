...
const SCHOOL_DATA = {
  ...
  general: {
    name: "CM Rise Tihlibai Government Excellence Higher Secondary School Waraseoni",
    shortName: "CM Rise School Waraseoni",
    newName: "महर्षि सांदीपनि विद्यालय वारासिवनी (Maharishi Sandipani Vidyalaya Waraseoni)",
    address: "तुमड़ी, बालाघाट रोड, वारासिवनी, मध्य प्रदेश – 481331",
    district: "बालाघाट (Balaghat)",
    state: "मध्य प्रदेश (Madhya Pradesh)",
    pincode: "481331",
    phone: "07632-XXXXXX",
    email: "cmrisewaraseoni@mp.gov.in",
    website: "https://www.vimarsh.mp.gov.in",
    principal: "श्री टी.के. गौतम (Shri T.K. Goutam)",
    udiseCode: "23450706733",
    establishedYear: "CM Rise के तहत अपग्रेड",
